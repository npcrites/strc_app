          ...
          <>
            ...
            <View style={{ zIndex: 1 }}>
              <View style={styles.bottomTabBar}>
                ...
                >
                  <LinearGradient
                    colors={[Colors.green + 'E6', Colors.green + 'CC']}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 1 }}
                    style={StyleSheet.absoluteFill}
                  />
                  <View style={styles.buySellButtonTextContainer}>
                ...
                >
                  <LinearGradient
                    colors={[Colors.red + 'E6', Colors.red + 'CC']}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 1 }}
                    style={StyleSheet.absoluteFill}
                  />
